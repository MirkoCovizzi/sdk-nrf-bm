...
uint16_t update_flags_check_test(uint16_t n_expected_calls, uint32_t n_call)
{
	...
	conn_handle = 2;
	__cmock_nrf_mtx_trylock_ExpectAndReturn(&m_db_update_in_progress_mutex, true);
	__cmock_gscm_local_db_cache_update_ExpectAndReturn(conn_handle,
...
uint16_t service_changed_flags_check_test(uint16_t n_expected_calls, uint32_t n_call)
{
	...
	/* Success. */
	conn_handle = 0;
	__cmock_ble_conn_state_user_flag_get_ExpectAndReturn(conn_handle,
							     m_arbitrary_flag_id_sc_sent, false);
	...
	__cmock_ble_conn_state_user_flag_set_Expect(conn_handle, m_arbitrary_flag_id_sc, true);
	__cmock_ble_conn_state_user_flag_set_Expect(conn_handle, m_arbitrary_flag_id_sc_sent,
						    false);
	...
	__cmock_sd_ble_gatts_initial_user_handle_get_ExpectAndReturn(&m_arbitrary_handle,
								     NRF_SUCCESS);
	...
	__cmock_sd_ble_gatts_attr_get_ExpectAnyArgsAndReturn(NRF_SUCCESS);
	__cmock_sd_ble_gatts_attr_get_ExpectAnyArgsAndReturn(NRF_SUCCESS);
	__cmock_sd_ble_gatts_value_get_StubWithCallback(
		sd_ble_gatts_value_get_success_stub_ind_off);
...
uint16_t service_changed_flags_check_test_2(uint16_t n_expected_calls, uint32_t n_call)
{
	...
	conn_handle = 1;
	__cmock_ble_conn_state_user_flag_get_ExpectAndReturn(conn_handle,
							     m_arbitrary_flag_id_sc_sent, true);
...
uint16_t apply_flags_check_test(uint16_t n_expected_calls, uint32_t n_call)
{
	...
	conn_handle = 1;
	__cmock_gscm_local_db_cache_apply_ExpectAndReturn(conn_handle,
							  BLE_ERROR_INVALID_CONN_HANDLE);
	__cmock_ble_conn_state_user_flag_set_Expect(conn_handle, m_arbitrary_flag_id_apply, false);
...
void test_init(void)
{
	...
	__cmock_ble_conn_state_user_flag_acquire_ExpectAndReturn(BLE_CONN_STATE_USER_FLAG_INVALID);
	__cmock_ble_conn_state_user_flag_acquire_ExpectAndReturn(BLE_CONN_STATE_USER_FLAG_INVALID);
	__cmock_ble_conn_state_user_flag_acquire_ExpectAndReturn(BLE_CONN_STATE_USER_FLAG_INVALID);
	__cmock_ble_conn_state_user_flag_acquire_ExpectAndReturn(BLE_CONN_STATE_USER_FLAG_INVALID);
	__cmock_ble_conn_state_user_flag_acquire_ExpectAndReturn(BLE_CONN_STATE_USER_FLAG_INVALID);
...
void test_gcm_ble_evt_handler_BLE_GATTS_EVT_SYS_ATTR_MISSING(void)
{
	...
	__cmock_im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle,
							      m_arbitrary_peer_id);
	__cmock_ble_conn_state_user_flag_set_Expect(m_arbitrary_conn_handle,
						    m_arbitrary_flag_id_apply, false);
	__cmock_ble_conn_state_for_each_set_user_flag_ExpectAndReturn(
		m_arbitrary_flag_id_apply, apply_pending_handle, NULL, 0);
	__cmock_ble_conn_state_for_each_set_user_flag_ExpectAndReturn(
		m_arbitrary_flag_id_sc, sc_send_pending_handle, NULL, 0);
	...
	__cmock_ble_conn_state_user_flag_set_Expect(m_arbitrary_conn_handle,
						    m_arbitrary_flag_id_apply, true);
	__cmock_ble_conn_state_for_each_set_user_flag_ExpectAndReturn(
		m_arbitrary_flag_id_apply, apply_pending_handle, NULL, 0);
	__cmock_ble_conn_state_for_each_set_user_flag_ExpectAndReturn(
		m_arbitrary_flag_id_sc, sc_send_pending_handle, NULL, 0);
...
void test_gcm_ble_evt_handler_BLE_GATTS_EVT_SC_CONFIRM(void)
{
	...
	__cmock_ble_conn_state_user_flag_set_Expect(m_arbitrary_conn_handle,
						    m_arbitrary_flag_id_sc_sent, false);
	__cmock_ble_conn_state_user_flag_set_Expect(m_arbitrary_conn_handle, m_arbitrary_flag_id_sc,
						    false);
	__cmock_im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle,
							      m_arbitrary_peer_id);
	__cmock_ble_conn_state_for_each_set_user_flag_ExpectAndReturn(
...
void test_gcm_ble_evt_handler_BLE_GATTS_EVT_WRITE(void)
{
	...
	/* Success */
	__cmock_ble_conn_state_user_flag_set_Expect(m_arbitrary_conn_handle,
						    m_arbitrary_flag_id_update, true);
	__cmock_ble_conn_state_for_each_set_user_flag_ExpectAndReturn(
		m_arbitrary_flag_id_update, db_update_pending_handle, NULL, 0);
	__cmock_ble_conn_state_for_each_set_user_flag_ExpectAndReturn(
		m_arbitrary_flag_id_car_upd, car_update_pending_handle, NULL, 0);
	__cmock_ble_conn_state_for_each_set_user_flag_ExpectAndReturn(
		m_arbitrary_flag_id_apply, apply_pending_handle, NULL, 0);
	__cmock_ble_conn_state_for_each_set_user_flag_ExpectAndReturn(
		m_arbitrary_flag_id_sc, sc_send_pending_handle, NULL, 0);
...
void test_gcm_ble_evt_handler_BLE_GATTC_EVT_CHAR_VAL_BY_UUID_READ_RSP(void)
{
	...
	__cmock_ble_conn_state_user_flag_set_Expect(m_arbitrary_conn_handle,
						    m_arbitrary_flag_id_car_upd, false);
	__cmock_im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle,
							      m_arbitrary_peer_id);
	...
	__cmock_ble_conn_state_user_flag_get_ExpectAndReturn(m_arbitrary_conn_handle2,
							     m_arbitrary_flag_id_car_hdl, true);
	__cmock_ble_conn_state_user_flag_set_Expect(m_arbitrary_conn_handle2,
						    m_arbitrary_flag_id_car_hdl, false);
...
void test_im_evt_handler(void)
{
	...
	__cmock_pds_peer_data_read_ExpectAndReturn(
		m_arbitrary_peer_id, PM_PEER_DATA_ID_CENTRAL_ADDR_RES, NULL, NULL, NRF_SUCCESS);
...
static uint32_t pds_read_stub_sc_false(pm_peer_id_t peer_id, pm_peer_data_id_t data_id,
				       ...
				       uint32_t const *const p_buf_len, int num_calls)
{
...
void test_pdb_evt_handler(void)
{
	...
	__cmock_pds_peer_data_read_ExpectAndReturn(m_arbitrary_peer_id,
						   PM_PEER_DATA_ID_SERVICE_CHANGED_PENDING, NULL,
	...
	__cmock_pds_peer_data_read_ExpectAndReturn(m_arbitrary_peer_id,
						   PM_PEER_DATA_ID_CENTRAL_ADDR_RES, NULL, NULL,
						   NRF_ERROR_NOT_FOUND);
	__cmock_pds_peer_data_read_IgnoreArg_p_data();
	__cmock_pds_peer_data_read_IgnoreArg_p_buf_len();
	__cmock_ble_conn_state_user_flag_set_Expect(m_arbitrary_conn_handle,
						    m_arbitrary_flag_id_car_upd, true);
	__cmock_ble_conn_state_for_each_set_user_flag_ExpectAndReturn(
		m_arbitrary_flag_id_update, db_update_pending_handle, NULL, 0);
	__cmock_ble_conn_state_for_each_set_user_flag_ExpectAndReturn(
		m_arbitrary_flag_id_car_upd, car_update_pending_handle, NULL, 0);
	...
	/* OTHER */
	__cmock_ble_conn_state_for_each_set_user_flag_ExpectAndReturn(
		m_arbitrary_flag_id_update, db_update_pending_handle, NULL, 1);
