...
void test_gscm_local_db_cache_update(void)
{
	...
	__cmock_im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle,
							      m_arbitrary_peer_id);
	__cmock_pdb_write_buf_get_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL,
						  1, &returned_peer_data, NRF_ERROR_BUSY);
	...
	__cmock_im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle,
							      m_arbitrary_peer_id);
	__cmock_pdb_write_buf_get_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL,
						  1, &returned_peer_data, NRF_SUCCESS);
	__cmock_pdb_write_buf_get_IgnoreArg_p_peer_data();
	...
	__cmock_pdb_write_buf_release_ExpectAndReturn(m_arbitrary_peer_id,
						      PM_PEER_DATA_ID_GATT_LOCAL, NRF_SUCCESS);
	__cmock_pdb_write_buf_get_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL,
						  2, &returned_peer_data, NRF_SUCCESS);
	__cmock_pdb_write_buf_get_IgnoreArg_p_peer_data();
	__cmock_pdb_write_buf_get_ReturnThruPtr_p_peer_data(&returned_peer_data);
	__cmock_sd_ble_gatts_sys_attr_get_ExpectWithArrayAndReturn(
		m_arbitrary_conn_handle, &m_arbitrary_local_gatt_data->data[0], 0,
	...
	__cmock_pdb_write_buf_release_ExpectAndReturn(m_arbitrary_peer_id,
						      PM_PEER_DATA_ID_GATT_LOCAL, NRF_SUCCESS);
	__cmock_pdb_write_buf_get_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL,
						  3, &returned_peer_data, NRF_ERROR_BUSY);
	__cmock_pdb_write_buf_get_IgnoreArg_p_peer_data();
	...
	__cmock_pdb_write_buf_release_ExpectAndReturn(m_arbitrary_peer_id,
						      PM_PEER_DATA_ID_GATT_LOCAL, NRF_SUCCESS);
	__cmock_pdb_write_buf_get_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL,
						  2, &returned_peer_data, NRF_ERROR_INVALID_PARAM);
	__cmock_pdb_write_buf_get_IgnoreArg_p_peer_data();
	...
	__cmock_sd_ble_gatts_sys_attr_get_ExpectWithArrayAndReturn(
		...
		NRF_SUCCESS);
	__cmock_sd_ble_gatts_sys_attr_get_IgnoreArg_p_sys_attr_data();
	__cmock_sd_ble_gatts_sys_attr_get_ReturnArrayThruPtr_p_sys_attr_data(
		m_arbitrary_sys_attr_data, m_arbitrary_sys_attr_len);
	__cmock_sd_ble_gatts_sys_attr_get_ReturnThruPtr_p_len(
		((uint16_t *)&m_arbitrary_sys_attr_len));

	__cmock_pds_peer_data_read_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL,
						   NULL, NULL, NRF_ERROR_INVALID_PARAM);
	...
	__cmock_pdb_write_buf_release_ExpectAndReturn(m_arbitrary_peer_id,
						      PM_PEER_DATA_ID_GATT_LOCAL, NRF_SUCCESS);
	__cmock_pdb_write_buf_get_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL,
						  3, &returned_peer_data, NRF_SUCCESS);
	__cmock_pdb_write_buf_get_IgnoreArg_p_peer_data();
	__cmock_pdb_write_buf_get_ReturnThruPtr_p_peer_data(&returned_peer_data);
	__cmock_sd_ble_gatts_sys_attr_get_ExpectWithArrayAndReturn(
		m_arbitrary_conn_handle, &m_arbitrary_local_gatt_data->data[0], 0,
...
void test_gscm_local_db_cache_apply(void)
{
	...
	__cmock_im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle,
							      PM_PEER_ID_INVALID);
	__cmock_sd_ble_gatts_sys_attr_set_ExpectAndReturn(m_arbitrary_conn_handle, NULL, 0,
							  SYS_ATTR_BOTH, NRF_SUCCESS);
...
void test_gscm_local_database_has_changed1(void)
{
	...
	for (uint16_t i = 0; i < 3; i++) {
		__cmock_pds_next_peer_id_get_ExpectAndReturn(m_arbitrary_peer_id,
							     m_arbitrary_peer_id);
		__cmock_pds_peer_data_store_ExpectAndReturn(m_arbitrary_peer_id, NULL, NULL,
							    NRF_SUCCESS);
		__cmock_pds_peer_data_store_IgnoreArg_p_peer_data();
...
void test_gscm_service_changed_ind_needed(void)
{
	...
	pm_peer_data_t returned_peer_data = {.data_id = PM_PEER_DATA_ID_SERVICE_CHANGED_PENDING,
	...
	__cmock_pds_peer_data_read_ExpectAndReturn(
		PM_PEER_ID_INVALID, PM_PEER_DATA_ID_SERVICE_CHANGED_PENDING, &returned_peer_data,
...
void test_gscm_service_changed_ind_send(void)
{
	...
	__cmock_sd_ble_gatts_initial_user_handle_get_IgnoreArg_p_handle();
	__cmock_sd_ble_gatts_service_changed_ExpectAndReturn(BLE_CONN_HANDLE_INVALID, 0x0000,
							     0xFFFF, BLE_ERROR_INVALID_CONN_HANDLE);

	err_code = gscm_service_changed_ind_send(BLE_CONN_HANDLE_INVALID);
	TEST_ASSERT_EQUAL_UINT(BLE_ERROR_INVALID_CONN_HANDLE, err_code);

	/* Invalid attr handles. Will reattempt until valid. Will also look for SC CCCD handle. */
	__cmock_sd_ble_gatts_initial_user_handle_get_ExpectAndReturn(NULL, NRF_SUCCESS);
	__cmock_sd_ble_gatts_initial_user_handle_get_IgnoreArg_p_handle();

	/* Attempt 1. */
	__cmock_sd_ble_gatts_service_changed_ExpectAndReturn(m_arbitrary_conn_handle, 0x0000,
							     0xFFFF, BLE_ERROR_INVALID_ATTR_HANDLE);

	/* Attempt 2. */
	__cmock_sd_ble_gatts_service_changed_ExpectAndReturn(m_arbitrary_conn_handle, 0x0001,
							     0xFFFF, BLE_ERROR_INVALID_ATTR_HANDLE);

	/* Attempt 3. */
	__cmock_sd_ble_gatts_service_changed_ExpectAndReturn(m_arbitrary_conn_handle, 0x0002,
							     0xFFFF, BLE_ERROR_INVALID_ATTR_HANDLE);

	/* Attempt 4: Success. */
	__cmock_sd_ble_gatts_service_changed_ExpectAndReturn(m_arbitrary_conn_handle, 0x0003,
							     0xFFFF, NRF_SUCCESS);
	...
	__cmock_sd_ble_gatts_initial_user_handle_get_ExpectAndReturn(NULL, NRF_SUCCESS);
	__cmock_sd_ble_gatts_initial_user_handle_get_IgnoreArg_p_handle();
	__cmock_sd_ble_gatts_service_changed_ExpectAndReturn(
		m_arbitrary_conn_handle, 0x0000, 0xFFFF, BLE_ERROR_GATTS_SYS_ATTR_MISSING);
	__cmock_sd_ble_gatts_service_changed_IgnoreArg_start_handle();
	...
	__cmock_sd_ble_gatts_initial_user_handle_get_IgnoreArg_p_handle();
	__cmock_sd_ble_gatts_service_changed_ExpectAndReturn(m_arbitrary_conn_handle, 0x0000,
							     0xFFFF, NRF_ERROR_INVALID_STATE);
	__cmock_sd_ble_gatts_service_changed_IgnoreArg_start_handle();
	...
	__cmock_sd_ble_gatts_initial_user_handle_get_IgnoreArg_p_handle();
	__cmock_sd_ble_gatts_service_changed_ExpectAndReturn(m_arbitrary_conn_handle, 0x0000,
							     0xFFFF, NRF_ERROR_NOT_SUPPORTED);
	__cmock_sd_ble_gatts_service_changed_IgnoreArg_start_handle();
