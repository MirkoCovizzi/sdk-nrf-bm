...
void test_params_reply(void)
{
	...
	__cmock_sd_ble_gap_sec_params_reply_ExpectWithArrayAndReturn(
		...
		&expected_keyset, 1, NRF_ERROR_INVALID_PARAM);
	...
	__cmock_ble_conn_state_role_ExpectAndReturn(m_arbitrary_conn_handle, BLE_GAP_ROLE_CENTRAL);
	__cmock_sd_ble_gap_sec_params_reply_ExpectAndReturn(m_arbitrary_conn_handle,
...
void expect_sec_proc_start_evt(pm_evt_t *p_pm_evt, pm_conn_sec_procedure_t procedure,
...
void test_link_secure(void)
{
	...
	__cmock_sd_ble_gap_authenticate_ExpectAndReturn(m_arbitrary_conn_handle, NULL,
	...
	TEST_ASSERT_EQUAL_UINT32(NRF_SUCCESS, err);
	TEST_ASSERT_EQUAL_UINT32(1 * SMD_EVENT_HANDLERS_CNT, m_n_evt_handler_calls);
	expect_sec_proc_start_evt(&m_evt_handler_records[0], PM_CONN_SEC_PROCEDURE_BONDING,
				  m_arbitrary_peer_id);
	evt_handler_call_record_clear();
	...
	TEST_ASSERT_EQUAL_UINT32(NRF_SUCCESS, err);
	TEST_ASSERT_EQUAL_UINT32(1 * SMD_EVENT_HANDLERS_CNT, m_n_evt_handler_calls);
	expect_sec_proc_start_evt(&m_evt_handler_records[0], PM_CONN_SEC_PROCEDURE_PAIRING,
				  PM_PEER_ID_INVALID);
	evt_handler_call_record_clear();
	...
	__cmock_im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle,
							      m_arbitrary_peer_id);
	__cmock_pdb_peer_data_ptr_get_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_BONDING,
						      NULL, NRF_SUCCESS);
	...
	__cmock_im_master_id_is_valid_ExpectAndReturn(&bonding_data.peer_ltk.master_id,
						      false); /* HERE */
	__cmock_ble_conn_state_user_flag_set_Expect(m_arbitrary_conn_handle,
						    m_arbitrary_flag_id_sec_proc, false);
	...
	TEST_ASSERT_EQUAL_UINT32(NRF_SUCCESS, err);
	TEST_ASSERT_EQUAL_UINT32(1 * SMD_EVENT_HANDLERS_CNT, m_n_evt_handler_calls);
	expect_sec_proc_start_evt(&m_evt_handler_records[0], PM_CONN_SEC_PROCEDURE_ENCRYPTION,
				  m_arbitrary_peer_id);
	evt_handler_call_record_clear();
...
void sec_info_req_evt_constuct(ble_evt_t *p_ble_evt, uint16_t conn_handle,
			       ble_gap_master_id_t master_id, uint8_t enc_info, uint8_t id_info)
{
...
void sec_request_evt_constuct(ble_evt_t *p_ble_evt, uint16_t conn_handle, uint8_t bond,
			      uint8_t mitm)
{
#if defined(BLE_GAP_ROLE_CENTRAL)
...
void auth_status_evt_constuct(ble_evt_t *p_ble_evt, uint16_t conn_handle, uint8_t auth_status,
			      uint8_t bonded, ble_gap_sec_kdist_t kdist_own,
...
ble_evt_t *sec_info_req_evt(uint16_t conn_handle, ble_gap_master_id_t master_id, uint8_t enc_info,
			    uint8_t id_info)
{
	static ble_evt_t ble_evt;
...
ble_evt_t *sec_request_evt(uint16_t conn_handle, uint8_t bond, uint8_t mitm)
{
	static ble_evt_t ble_evt;
...
ble_evt_t *auth_status_evt(uint16_t conn_handle, uint8_t auth_status, uint8_t bonded,
			   ble_gap_sec_kdist_t kdist_own, ble_gap_sec_kdist_t kdist_peer)
{
	static ble_evt_t ble_evt;
...
void test_smd_ble_evt_handler(void)
{
	...
	__cmock_ble_conn_state_user_flag_set_Expect(m_arbitrary_conn_handle,
						    m_arbitrary_flag_id_pairing, true);
	__cmock_ble_conn_state_user_flag_set_Expect(m_arbitrary_conn_handle,
						    m_arbitrary_flag_id_bonding, true);
	__cmock_im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle,
							      m_arbitrary_peer_id);
	__cmock_im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle,
							      m_arbitrary_peer_id);
	...
	expect_sec_proc_start_evt(&m_evt_handler_records[0], PM_CONN_SEC_PROCEDURE_BONDING,
				  m_arbitrary_peer_id);
	TEST_ASSERT_EQUAL_UINT32(m_evt_handler_records[1 * SMD_EVENT_HANDLERS_CNT].conn_handle,
				 m_arbitrary_conn_handle);
	TEST_ASSERT_EQUAL_UINT32(m_evt_handler_records[1 * SMD_EVENT_HANDLERS_CNT].evt_id,
	...
	TEST_ASSERT_EQUAL_UINT32(1 * SMD_EVENT_HANDLERS_CNT, m_n_evt_handler_calls);
	TEST_ASSERT_EQUAL_UINT32(m_evt_handler_records[0 * SMD_EVENT_HANDLERS_CNT].conn_handle,
				 m_arbitrary_conn_handle);
	TEST_ASSERT_EQUAL_UINT32(m_evt_handler_records[0 * SMD_EVENT_HANDLERS_CNT].evt_id,
				 PM_EVT_CONN_SEC_PARAMS_REQ);
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_peer_id,
	...
	ble_evt_t *p_ble_evt =
		sec_info_req_evt(m_arbitrary_conn_handle, m_arbitrary_master_id, 1, 0);
	...
	__cmock_pdb_peer_data_ptr_get_IgnoreArg_p_peer_data();
	__cmock_sd_ble_gap_sec_info_reply_ExpectAndReturn(m_arbitrary_conn_handle, NULL, NULL, NULL,
							  NRF_ERROR_INVALID_PARAM);
	__cmock_im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle,
							      m_arbitrary_peer_id);
	...
	expect_sec_proc_start_evt(&m_evt_handler_records[0], PM_CONN_SEC_PROCEDURE_ENCRYPTION,
				  m_arbitrary_peer_id);
	TEST_ASSERT_EQUAL_UINT32(PM_EVT_ERROR_UNEXPECTED,
				 m_evt_handler_records[1 * SMD_EVENT_HANDLERS_CNT].evt_id);
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_conn_handle,
	...
	expect_sec_proc_start_evt(&m_evt_handler_records[0], PM_CONN_SEC_PROCEDURE_ENCRYPTION,
				  m_arbitrary_peer_id);
	TEST_ASSERT_EQUAL_UINT32(PM_EVT_CONN_SEC_FAILED,
				 m_evt_handler_records[1 * SMD_EVENT_HANDLERS_CNT].evt_id);
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_conn_handle,
				 m_evt_handler_records[1 * SMD_EVENT_HANDLERS_CNT].conn_handle);
	TEST_ASSERT_EQUAL_UINT32(
	...
	__cmock_pdb_peer_data_ptr_get_IgnoreArg_p_peer_data();
	__cmock_pdb_peer_data_ptr_get_ReturnThruPtr_p_peer_data(&returned_peer_data);
	__cmock_im_master_ids_compare_ExpectAndReturn(
		&returned_peer_data.p_bonding_data->own_ltk.master_id,
		&p_ble_evt->evt.gap_evt.params.sec_info_request.master_id, false);
	__cmock_sd_ble_gap_sec_info_reply_ExpectAndReturn(m_arbitrary_conn_handle, NULL, NULL, NULL,
							  NRF_SUCCESS);
	sec_proc_expect_fail(m_arbitrary_peer_id);
	...
	__cmock_im_master_ids_compare_ExpectAndReturn(
		&returned_peer_data.p_bonding_data->own_ltk.master_id,
		&p_ble_evt->evt.gap_evt.params.sec_info_request.master_id, true);
	__cmock_sd_ble_gap_sec_info_reply_ExpectAndReturn(
		m_arbitrary_conn_handle, &m_arbitrary_bonding_data.own_ltk.enc_info, NULL, NULL,
		NRF_SUCCESS);
	...
	__cmock_im_peer_id_get_by_master_id_ExpectAndReturn(
		&p_ble_evt->evt.gap_evt.params.sec_info_request.master_id, PM_PEER_ID_INVALID);
	__cmock_im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle,
							      PM_PEER_ID_INVALID);
	__cmock_ble_conn_state_user_flag_set_Expect(m_arbitrary_conn_handle,
						    m_arbitrary_flag_id_sec_proc, true);
	...
	TEST_ASSERT_EQUAL_UINT32(
		BLE_GAP_SEC_STATUS_SOURCE_LOCAL,
		m_evt_handler_records[1 * SMD_EVENT_HANDLERS_CNT].params.conn_sec_failed.error_src);
	TEST_ASSERT_EQUAL_UINT32(PM_PEER_ID_INVALID,
				 m_evt_handler_records[1 * SMD_EVENT_HANDLERS_CNT].peer_id);
	evt_handler_call_record_clear();
	...
	p_auth_status_evt =
		auth_status_evt(m_arbitrary_conn_handle, auth_status, false, kdist_own, kdist_peer);
	...
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_conn_handle, m_evt_handler_records[0].conn_handle);
	TEST_ASSERT_EQUAL(PM_CONN_SEC_PROCEDURE_PAIRING,
			  m_evt_handler_records[0].params.conn_sec_succeeded.procedure);
	TEST_ASSERT_EQUAL_UINT32(false,
				 m_evt_handler_records[0].params.conn_sec_succeeded.data_stored);
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_peer_id,
				 m_evt_handler_records[0 * SMD_EVENT_HANDLERS_CNT].peer_id);
	evt_handler_call_record_clear();
	...
	p_auth_status_evt =
		auth_status_evt(m_arbitrary_conn_handle, auth_status, true, kdist_own, kdist_peer);
	...
	__cmock_im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle,
							      m_arbitrary_peer_id);
	__cmock_pdb_write_buf_store_ExpectAndReturn(PDB_TEMP_PEER_ID(m_arbitrary_conn_handle),
						    PM_PEER_DATA_ID_BONDING, m_arbitrary_peer_id,
						    NRF_SUCCESS);
	__cmock_im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle,
							      m_arbitrary_peer_id);
	...
	TEST_ASSERT_EQUAL_UINT32(PM_EVT_CONN_SEC_SUCCEEDED, m_evt_handler_records[0].evt_id);
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_conn_handle, m_evt_handler_records[0].conn_handle);
	TEST_ASSERT_EQUAL(PM_CONN_SEC_PROCEDURE_BONDING,
			  m_evt_handler_records[0].params.conn_sec_succeeded.procedure);
	...
	__cmock_im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle,
							      PM_PEER_ID_INVALID);
	__cmock_im_find_duplicate_bonding_data_ExpectAndReturn(
		&m_arbitrary_bonding_data, PM_PEER_ID_INVALID, PM_PEER_ID_INVALID);
	...
	__cmock_im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle,
							      PM_PEER_ID_INVALID);
	__cmock_im_find_duplicate_bonding_data_ExpectAndReturn(
		&m_arbitrary_bonding_data, PM_PEER_ID_INVALID, m_arbitrary_peer_id);
	__cmock_im_new_peer_id_Expect(m_arbitrary_conn_handle, m_arbitrary_peer_id);
	__cmock_ble_conn_state_user_flag_get_ExpectAndReturn(m_arbitrary_conn_handle,
							     m_arbitrary_flag_id_allow, false);
	__cmock_im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle,
	...
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_peer_id,
				 m_evt_handler_records[0 * SMD_EVENT_HANDLERS_CNT].peer_id);
	TEST_ASSERT_EQUAL_UINT32(PM_EVT_CONN_SEC_SUCCEEDED,
				 m_evt_handler_records[1 * SMD_EVENT_HANDLERS_CNT].evt_id);
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_conn_handle,
				 m_evt_handler_records[1 * SMD_EVENT_HANDLERS_CNT].conn_handle);
	TEST_ASSERT_EQUAL(PM_CONN_SEC_PROCEDURE_BONDING,
			  m_evt_handler_records[1 * SMD_EVENT_HANDLERS_CNT]
				  .params.conn_sec_succeeded.procedure);
	TEST_ASSERT_EQUAL_UINT32(false, m_evt_handler_records[1 * SMD_EVENT_HANDLERS_CNT]
						.params.conn_sec_succeeded.data_stored);
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_peer_id,
				 m_evt_handler_records[1 * SMD_EVENT_HANDLERS_CNT].peer_id);
	...
	TEST_ASSERT_EQUAL(PM_CONN_SEC_PROCEDURE_BONDING,
			  m_evt_handler_records[1 * SMD_EVENT_HANDLERS_CNT]
				  .params.conn_sec_succeeded.procedure);
	TEST_ASSERT_EQUAL_UINT32(true, m_evt_handler_records[1 * SMD_EVENT_HANDLERS_CNT]
					       .params.conn_sec_succeeded.data_stored);
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_peer_id,
				 m_evt_handler_records[1 * SMD_EVENT_HANDLERS_CNT].peer_id);
	...
	TEST_ASSERT_EQUAL(PM_CONN_SEC_PROCEDURE_BONDING,
			  m_evt_handler_records[0 * SMD_EVENT_HANDLERS_CNT]
				  .params.conn_sec_succeeded.procedure);
	TEST_ASSERT_EQUAL_UINT32(true, m_evt_handler_records[0 * SMD_EVENT_HANDLERS_CNT]
					       .params.conn_sec_succeeded.data_stored);
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_peer_id,
				 m_evt_handler_records[0 * SMD_EVENT_HANDLERS_CNT].peer_id);
	...
	sec_proc_expect_end();
	__cmock_pdb_write_buf_get_ExpectAndReturn(PDB_TEMP_PEER_ID(m_arbitrary_conn_handle),
						  PM_PEER_DATA_ID_BONDING, 1, NULL,
						  NRF_ERROR_INTERNAL);
	__cmock_pdb_write_buf_get_IgnoreArg_p_peer_data();
	__cmock_im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle,
							      m_arbitrary_peer_id);
	...
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_conn_handle, m_evt_handler_records[0].conn_handle);
	TEST_ASSERT_EQUAL_UINT32(NRF_ERROR_INTERNAL,
	...
	TEST_ASSERT_EQUAL_UINT32(PM_EVT_ERROR_UNEXPECTED, m_evt_handler_records[0].evt_id);
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_conn_handle, m_evt_handler_records[0].conn_handle);
	TEST_ASSERT_EQUAL_UINT32(NRF_ERROR_NO_MEM,
				 m_evt_handler_records[0].params.error_unexpected.error);
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_peer_id,
				 m_evt_handler_records[0 * SMD_EVENT_HANDLERS_CNT].peer_id);
	TEST_ASSERT_EQUAL_UINT32(PM_EVT_CONN_SEC_SUCCEEDED,
	...
	TEST_ASSERT_EQUAL_UINT32(PM_EVT_ERROR_UNEXPECTED, m_evt_handler_records[0].evt_id);
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_conn_handle, m_evt_handler_records[0].conn_handle);
	TEST_ASSERT_EQUAL_UINT32(NRF_ERROR_NOT_FOUND,
				 m_evt_handler_records[0].params.error_unexpected.error);
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_peer_id, m_evt_handler_records[0].peer_id);
	TEST_ASSERT_EQUAL_UINT32(PM_EVT_CONN_SEC_SUCCEEDED,
				 m_evt_handler_records[1 * SMD_EVENT_HANDLERS_CNT].evt_id);
	...
	__cmock_ble_conn_state_user_flag_get_ExpectAndReturn(m_arbitrary_conn_handle,
							     m_arbitrary_flag_id_bonding, true);
	__cmock_pdb_write_buf_release_ExpectAndReturn(PDB_TEMP_PEER_ID(m_arbitrary_conn_handle),
						      PM_PEER_DATA_ID_BONDING, NRF_SUCCESS);
	sec_proc_expect_fail(m_arbitrary_peer_id);
	...
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_conn_handle, m_evt_handler_records[0].conn_handle);
	TEST_ASSERT_EQUAL_UINT32(auth_status,
				 m_evt_handler_records[0].params.conn_sec_failed.error);
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_peer_id,
				 m_evt_handler_records[0 * SMD_EVENT_HANDLERS_CNT].peer_id);
	evt_handler_call_record_clear();
	...
	smd_ble_evt_handler(disconnected_evt(m_arbitrary_conn_handle,
					     BLE_HCI_CONN_TERMINATED_DUE_TO_MIC_FAILURE));
	TEST_ASSERT_EQUAL_UINT32(1 * SMD_EVENT_HANDLERS_CNT, m_n_evt_handler_calls);
	TEST_ASSERT_EQUAL_UINT32(PM_EVT_CONN_SEC_FAILED, m_evt_handler_records[0].evt_id);
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_conn_handle, m_evt_handler_records[0].conn_handle);
	TEST_ASSERT_EQUAL_UINT32(PM_CONN_SEC_PROCEDURE_ENCRYPTION,
				 m_evt_handler_records[0].params.conn_sec_failed.procedure);
	TEST_ASSERT_EQUAL_UINT32(PM_CONN_SEC_ERROR_MIC_FAILURE,
				 m_evt_handler_records[0].params.conn_sec_failed.error);
	TEST_ASSERT_EQUAL_UINT32(BLE_GAP_SEC_STATUS_SOURCE_LOCAL,
				 m_evt_handler_records[0].params.conn_sec_failed.error_src);
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_peer_id,
				 m_evt_handler_records[0 * SMD_EVENT_HANDLERS_CNT].peer_id);
	evt_handler_call_record_clear();
	...
	smd_ble_evt_handler(disconnected_evt(m_arbitrary_conn_handle,
					     BLE_HCI_CONN_TERMINATED_DUE_TO_MIC_FAILURE + 1));
	TEST_ASSERT_EQUAL_UINT32(1 * SMD_EVENT_HANDLERS_CNT, m_n_evt_handler_calls);
	TEST_ASSERT_EQUAL_UINT32(PM_EVT_CONN_SEC_FAILED, m_evt_handler_records[0].evt_id);
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_conn_handle, m_evt_handler_records[0].conn_handle);
	TEST_ASSERT_EQUAL_UINT32(PM_CONN_SEC_PROCEDURE_ENCRYPTION,
				 m_evt_handler_records[0].params.conn_sec_failed.procedure);
	TEST_ASSERT_EQUAL_UINT32(PM_CONN_SEC_ERROR_DISCONNECT,
				 m_evt_handler_records[0].params.conn_sec_failed.error);
	TEST_ASSERT_EQUAL_UINT32(BLE_GAP_SEC_STATUS_SOURCE_LOCAL,
				 m_evt_handler_records[0].params.conn_sec_failed.error_src);
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_peer_id,
	...
	TEST_ASSERT_EQUAL_UINT32(PM_EVT_CONN_SEC_FAILED, m_evt_handler_records[0].evt_id);
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_conn_handle, m_evt_handler_records[0].conn_handle);
	TEST_ASSERT_EQUAL_UINT32(PM_CONN_SEC_PROCEDURE_PAIRING,
				 m_evt_handler_records[0].params.conn_sec_failed.procedure);
	TEST_ASSERT_EQUAL_UINT32(PM_CONN_SEC_ERROR_DISCONNECT,
				 m_evt_handler_records[0].params.conn_sec_failed.error);
	TEST_ASSERT_EQUAL_UINT32(BLE_GAP_SEC_STATUS_SOURCE_LOCAL,
	...
	__cmock_ble_conn_state_user_flag_get_ExpectAndReturn(m_arbitrary_conn_handle,
							     m_arbitrary_flag_id_bonding, false);
	__cmock_pdb_write_buf_release_ExpectAndReturn(PDB_TEMP_PEER_ID(m_arbitrary_conn_handle),
						      PM_PEER_DATA_ID_BONDING, NRF_ERROR_NOT_FOUND);
	sec_proc_expect_end();
	__cmock_im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle,
							      m_arbitrary_peer_id);
	...
	__cmock_ble_conn_state_user_flag_get_ExpectAndReturn(m_arbitrary_conn_handle,
							     m_arbitrary_flag_id_bonding, true);
	__cmock_pdb_write_buf_release_ExpectAndReturn(PDB_TEMP_PEER_ID(m_arbitrary_conn_handle),
						      PM_PEER_DATA_ID_BONDING, NRF_ERROR_INTERNAL);
	__cmock_im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle,
							      m_arbitrary_peer_id);
	sec_proc_expect_end();
	__cmock_im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle,
	...
	TEST_ASSERT_EQUAL_UINT32(PM_CONN_SEC_PROCEDURE_BONDING,
				 m_evt_handler_records[1].params.conn_sec_failed.procedure);
	evt_handler_call_record_clear();
	...
	__cmock_ble_conn_state_user_flag_get_ExpectAndReturn(
		m_arbitrary_conn_handle, m_arbitrary_flag_id_pairing, pairing_proc);
	...
	TEST_ASSERT_EQUAL_UINT32(PM_EVT_CONN_SEC_FAILED, m_evt_handler_records[0].evt_id);
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_conn_handle, m_evt_handler_records[0].conn_handle);
	TEST_ASSERT_EQUAL_UINT32(PM_CONN_SEC_ERROR_PIN_OR_KEY_MISSING,
				 m_evt_handler_records[0].params.conn_sec_failed.error);
	TEST_ASSERT_EQUAL_UINT32(BLE_GAP_SEC_STATUS_SOURCE_REMOTE,
				 m_evt_handler_records[0].params.conn_sec_failed.error_src);
	TEST_ASSERT_EQUAL_UINT32(m_arbitrary_peer_id,
				 m_evt_handler_records[0 * SMD_EVENT_HANDLERS_CNT].peer_id);
	evt_handler_call_record_clear();
